  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status = 'success') location.reload(true); //reload the page, the browser will send another request with fake cookie and in isLoggedIn middleware it will find that the cookie is fake
          _context2.next = 11;
          break;
        case 7:
          _context2.prev = 7;
